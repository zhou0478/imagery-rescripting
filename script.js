document.addEventListener('DOMContentLoaded', () => {
  const slides = [
    ...
    `
      <div class="slide">
        <h2>Step 2</h2>
        <p>Placeholder for Step 2 instructions and input...</p>
        <textarea placeholder="Write your response for Step 2..."></textarea>
      </div>
    `
  ];
  ...
  // ✅ Show the initial slide when everything is ready
  showSlide(currentSlide);
});
